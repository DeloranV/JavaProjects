package Misc;
 ...
 class Bike{
	...
	void outputAll() {
		System.out.print("\nID: " + bikeID + "    Ilość biegów: " + gears_Number + "    Cena: " + price + " zł" + "    Gwarancja: " + warranty + " lat(a)"
				+ "    Ilość kół: " + WHEELS_NUM);
	}
...
public class Bikes_OOP {
	public static void main(String[] args) {
		...
		//System.out.println(rower1.gears_Number);   NOT WORKING - PRIVATE MAKES IT ACCESIBLE ONLY FROM WITHIN ITS CLASS
